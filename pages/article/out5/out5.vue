<template>
	<view class="page">
		...
		<view class="article">
			<text>日前印发的《中共中央 国务院关于全面加强生态环境保护 坚决打好污染防治攻坚战的意见》明确指出，“打好农业农村污染治理攻坚战”“加快推进垃圾分类处理”，并强调，“推进农村垃圾就地分类、资源化利用和处理，建立农村有机废弃物收集、转化、利用网络体系”。
...
　　“流”：形成信息分享反馈机制，让信息流动起来。一是形成“政府—企业—公众”绿色信息管理平台，建议由政府引导，在利用云计算、大数据等新一代信息技术基础上，实现环境统计、环境监测、污染源监控、环保投诉等信息的有效链接与整合，畅通公众监督反馈渠道。二是加强有关部门的引导和督导，大力开展垃圾减量和科学分类的全民教育，比如创建绿色家庭、绿色学校等活动，让绿色生活知识流动起来，助推垃圾分类工作实现预期目标。</text>
		</view>
		</view>
</template>
