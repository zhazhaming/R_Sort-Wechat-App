<template>
	<view class="pag2">
		<view class="bg2">
			<image 
			src="https://s2.loli.net/2022/06/24/v6FWSZc42iOzAsG.png" 
			></image>
		
		</view>
		<view class="top-title">
			<image src="https://s2.loli.net/2022/06/24/h2QaP7XKU3MSVv5.png" ></image>
		</view>
		<view class="article">
			<text>  农村垃圾分类实践成功和治理效果显著，虽然有国家动员、政府支持和制度设计、组织管理等多重原因，是与垃圾分类的乡村社会基础的实践切合有着密不可分的关系。
